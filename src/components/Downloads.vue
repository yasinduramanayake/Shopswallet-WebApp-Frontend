<template>
    <div class="mt-8 md:mt-20" v-if="settings">
        <div class="pt-5 bg-gray-50" v-if="settings.strings.website.websiteFooterImage != null" style="background-color: #0F2133">
            <div class="container max-w-6xl px-5 mx-auto">
                <div class="grid gap-4 md:grid-cols-2">
                    <div class="self-center pb-14 pt-14">
                        <h4 class="text-sm font-bold leading-relaxed md:text-4xl" style="color: white">{{ $t('downloadPage.header') }}</h4>
                        <p class="pt-5 font-light leading-normal text-gray-600 md:text-2l" style="color: white">ShopsWallet {{ $t('downloadPage.subHeader') }}</p>
        ...
        <div class="pt-5 bg-gray-50" v-else>
            <div class="container max-w-3xl px-5 mx-auto" >
                <div class="pb-14 pt-14">
                    ...
                    <p class="pt-5 font-light text-center leading-normal text-gray-600 md:text-2l">ShopsWallet {{ $t('downloadPage.subHeader') }}</p>
