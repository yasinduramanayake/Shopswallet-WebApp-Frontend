<template>
  <div class="px-2">
    ...
    <div class="row">
      <div class="col-12">
        <div class="border border-info rounded text-dark p-3 lead" id="dv_new_arrivals" style="text-align: justify;">
          ...
          <a :href="$router.resolve({name: 'Product', params: { id: product.id, slug: sanitizeTitle(`${product.name}`) }}).href" class="w-60 h-68">
            ...
            <div class="p-3 ">
              ...
              <div class="flex justify-between">
                ...
                <div>
                  <div class="px-2 py-1 text-xs text-white bg-blue-300 rounded-full">{{ $t('pages.newArrival') }}</div>
                </div>
